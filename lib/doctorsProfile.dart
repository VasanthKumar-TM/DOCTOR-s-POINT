...
//load data into widgets
              Text("${(querySnapshot.documents[i].data as Map)['name']}"),
              Text("${(querySnapshot.documents[i].data as Map)['category']}"),
              Text("${(querySnapshot.documents[i].data as Map)['phnumber']}"),
            ],
          );
        },
      );
  ...
  getDriversList() async {
    return await Firestore.instance.collection('Doctors').getDocuments();
  }
}
